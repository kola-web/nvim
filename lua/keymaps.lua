...
keymap('n', 'BC', function()
  require('utils').scratch_open(vim.bo.filetype)
end, opts)
keymap('n', 'BS', function()
  require('utils').scratch_open('json')
end, opts)
keymap('n', 'BJ', function()
  require('utils').scratch_open('javascript')
end, opts)
keymap('n', 'BT', function()
  require('utils').scratch_open('typescript')
end, opts)
keymap('n', 'BV', function()
  require('utils').scratch_open('vue')
end, opts)
keymap('n', 'BH', function()
  require('utils').scratch_open('html')
end, opts)
keymap('n', 'BL', function()
  require('utils').scratch_open('lua')
end, opts)
keymap('n', 'BP', function()
