...
vim.keymap.set('n', '<leader>c', function() Snacks.bufdelete() end, { desc = 'buf del' })
vim.keymap.set('n', '<leader>bo', function() Snacks.bufdelete.other() end, { desc = 'buf del other' })
vim.keymap.set('n', '<leader>D', function() Snacks.dashboard.open() end, { desc = 'dashboard' })
vim.keymap.set('n', '<leader>z', function() Snacks.zen() end, { desc = 'zen modal' })
...
vim.keymap.set('n', '<leader>f',
  function() Snacks.picker.files({ hidden = true, args = { '--path-separator', '/' } }) end, { desc = 'Find Files' })
vim.keymap.set('n', '<leader>F', function() Snacks.picker.grep({ layout = { preset = 'ivy' } }) end, { desc = 'Grep' })
vim.keymap.set('n', '<leader>bb', function() Snacks.picker.buffers() end, { desc = 'Buffers' })
vim.keymap.set('n', '<leader>sc', function() Snacks.picker.colorschemes() end, { desc = '[S]earch [C]olorschemes' })
vim.keymap.set('n', '<leader>su', function() Snacks.picker.undo() end, { desc = '[S]earch [U]ndo ' })
vim.keymap.set('n', '<leader>sU', function() Snacks.picker.resume() end, { desc = '[S]earch [R]esume' })
...
vim.keymap.set('n', '<leader>sh', function() Snacks.picker.recent() end, { desc = 'recent' })
...
vim.keymap.set('n', '<leader>lt', function() require('utils').select_filetype() end, { desc = 'select filetype' })
vim.keymap.set('n', '<leader>pp', function() Snacks.picker.projects() end, { desc = 'select projects' })
...
vim.keymap.set('n', '<leader>so', function() Snacks.picker.lsp_symbols(require('utils').kind_filter) end,
  { desc = 'LSP Symbols' })
vim.keymap.set('n', '<leader>sO', function() Snacks.picker.lsp_workspace_symbols(require('utils').kind_filter) end,
