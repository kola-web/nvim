...
local M = {
  {
    ...
    keys = {
      ...
      {'<leader>lo',  function() Snacks.picker.lsp_symbols(require('utils').kind_filter) end,                        desc = 'LSP Symbols' },
      {'<leader>lO',  function() Snacks.picker.lsp_workspace_symbols(require('utils').kind_filter) end,              desc = 'LSP Workspace Symbols' },
    },
    init = function()
