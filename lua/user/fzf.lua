...
fzf.setup {
      ...
      local function feedkeys(normal_keys, insert_key)
        ...
        for _, key in ipairs(normal_keys) do
          vim.keymap.set('n', key, function()
            vim.api.nvim_chan_send(vim.b.terminal_job_id, vim.api.nvim_replace_termcodes(insert_key, true, false, true) or '')
  ...
  files = { prompt = '   Files ', fd_opts = '--color=never --type f --hidden --follow --exclude .git --exclude node_modules' },
