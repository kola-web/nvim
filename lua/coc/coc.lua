...
M.config = function()
  ...
  keyset('x', '<leader>m', '<Plug>(coc-format-selected)', { silent = true })
  keyset('v', '<leader>m', '<Plug>(coc-format-selected)', { silent = true })
  keyset('n', '<leader>m', '<Plug>(coc-format)', { silent = true })
  ...
  keyset('n', '<space>ld', ':<C-u>CocList diagnostics<cr>', opts)
  -- Manage extensions
  ...
  keyset('n', '<space>ls', ':<C-u>CocList -I symbols<cr>', opts)
